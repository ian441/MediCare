...
export default function AppointmentsPage() {
  ...
  const handleSubmit = () => {
    ...
    toast.success("Appointment booked successfully! 🎉", { description: "You will receive a confirmation SMS shortly." });
    navigate("/portal");
  };
            ...
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="flex justify-between mt-8">
                ...
                {step < 4 ? (
                  ...
                  <Button onClick={handleSubmit} className="gradient-medical border-0 text-primary-foreground">
