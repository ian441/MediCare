...
export const testimonials: Testimonial[] = [
  ...
  { id: "t2", name: "John Mutiso", text: "The telemedicine service is incredibly convenient. I consulted with Dr. Omondi from Mombasa and got my prescription delivered the same day.", rating: 5, service: "Telemedicine", avatar: "JM" },
